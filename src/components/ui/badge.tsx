...
const badgeVariants = cva(
  "inline-flex items-center rounded-md px-2 py-0.5 text-[15px] font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        default:
